...
export default function MyP2POrders() {
  ...
  const getStatusBadge = (status) => {
    switch(status) {
      ...
      case 'MATCHED': return <span style={{ background: 'rgba(59, 130, 246, 0.1)', color: '#3B82F6', padding: '4px 8px', borderRadius: '6px', fontSize: '0.7rem', display: 'flex', alignItems: 'center', gap: '4px' }}><AlertCircle size={12}/> รอคุณโอนเงิน</span>;
